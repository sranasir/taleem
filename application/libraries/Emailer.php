...
class Emailer
{
    ...
    public function send($data = array(), $queueOverride = null)
    {
        ...
        // Otherwise, send it.
        return $this->sendEmail($to, $from, $reply_to, $subject, $templated, $altMessage, $attachments);
    }
     ...
     * @return bool true on success, else false.
     */
    private function sendEmail($to, $from, $reply_to, $subject, $message, $altMessage = false, $attachments = false)
    {
